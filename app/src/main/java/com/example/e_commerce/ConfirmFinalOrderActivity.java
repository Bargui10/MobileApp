...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneEditText = (EditText) findViewById(R.id.shippment_number);
    ...
    private  void check(){
        if (TextUtils.isEmpty(nameEditText.getText().toString())){
            Toast.makeText(this, "Your Name Field is Empty", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(phoneEditText.getText().toString())){
            Toast.makeText(this, "Your Phone Field is Empty", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(addressEditText.getText().toString())){
            Toast.makeText(this, " Your Address Field is Empty", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(cityEditText.getText().toString())){
            Toast.makeText(this, "Your City Field is Empty", Toast.LENGTH_SHORT).show();
        }
        else {
            confirmOrder();
        }
